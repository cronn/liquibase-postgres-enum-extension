...
INSERT INTO public.databasechangelog VALUES ('change1', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 1, 'EXECUTED', '9:4b6982478dc5d873e2a5a2df4915c8c6', 'createPostgresEnumType name=colour', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change2', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 2, 'EXECUTED', '9:a89705da785e9daeffc3dc2e6adaa0e2', 'renamePostgresEnumType newName=color, oldName=colour', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change3', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 3, 'EXECUTED', '9:b9b7da0bc9ccdd850d013312f9fe97a6', 'addPostgresEnumValues enumTypeName=color', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change4', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 4, 'EXECUTED', '9:d77b821d2b89b652b1fb2f9124b81dd2', 'createTable tableName=simple_entity_with_enum; sql', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change5', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 5, 'EXECUTED', '9:ba0514d74b0eb7ccf7be91dd4511fc4b', 'renamePostgresEnumValue enumTypeName=color', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change6', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 6, 'EXECUTED', '9:5bda148ff2c03a342874b4979deaf392', 'createPostgresEnumType name=drop_me', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change7', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 7, 'EXECUTED', '9:44940c358b1483b3b6d0c8e3d072a818', 'dropPostgresEnumType name=drop_me', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change8', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 8, 'EXECUTED', '9:bb221ce19ea090295391f26eefbf5e61', 'createPostgresEnumType name=should_be_dropped', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change9', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 9, 'EXECUTED', '9:adac3bd97125e2a14931ae4befb926bb', 'createPostgresEnumType name=language; createTable tableName=entity_using_language1; createTable tableName=entity_using_language2; sql; sql', '', NULL, '5.0.2', NULL, NULL, 'test');
INSERT INTO public.databasechangelog VALUES ('change10', 'Jane Doe', 'migrations/full-changelog.xml', '2024-01-02 12:00:00', 10, 'EXECUTED', '9:abb4f59debeedd6c7a77b611d81043d3', 'modifyPostgresEnumType name=language', '', NULL, '5.0.2', NULL, NULL, 'test');
